...
# Redirect legacy media paths to the active storage
...
if settings.DEBUG:
    ...
    urlpatterns += static(getattr(settings, "MEDIA_URL", "/media/"), document_root=settings.MEDIA_ROOT)
else:
    # --- NEW: redirect legacy media paths to Cloudinary in prod
    urlpatterns += [
